...
export const IndiaWeatherMap: React.FC = () => {
  ...
  const [districtWeather, setDistrictWeather] =
    useState<CurrentWeather | null>(null);

  const [districtAlerts, setDistrictAlerts] =
  ...
  const [activeLayer, setActiveLayer] =
    useState<MapLayerType>('radar');

  // -------------------------------------------------------
  // India map center
  // -------------------------------------------------------

  const indiaCenter: [number, number] = [
    22.9734,
    78.6569,
  ];
  ...
  return (
    ...
    >
      ...
      {/* ===================================================
          3. DISTRICT DETAILS SIDE DRAWER
      =================================================== */}
